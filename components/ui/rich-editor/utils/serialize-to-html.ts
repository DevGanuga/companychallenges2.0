 ...
 * Uses CSS variables for theme-adaptive styling (light mode)
 */
function getBlockTypeClasses(type: string): string {
  switch (type) {
    case "h1":
      return "text-4xl font-bold leading-[1.2] mb-2"
    case "h2":
      return "text-3xl font-bold leading-[1.2] mb-1.5"
    case "h3":
      return "text-2xl font-bold leading-[1.2] mb-1"
    case "h4":
      return "text-xl font-semibold leading-[1.3] mb-1"
    case "h5":
      return "text-lg font-semibold leading-[1.4] mb-0.5"
    case "h6":
      return "text-base font-semibold leading-[1.4] mb-0.5"
    case "p":
      return "text-base leading-[1.6]"
    case "li":
      return "text-base leading-[1.6] list-disc list-inside"
    case "blockquote":
      return "text-base opacity-70 italic border-l-4 border-[var(--color-accent)] pl-6 py-1"
    case "code":
      return "font-mono text-sm bg-gray-100 px-4 py-2 rounded-lg whitespace-pre-wrap break-words"
    case "br":
      return ""
    default:
      return "text-base leading-[1.6]"
...
function getInlineElementTypeClasses(elementType: string): string {
  switch (elementType) {
    case "h1":
      return "text-4xl font-bold leading-[1.2]"
    case "h2":
      return "text-3xl font-bold leading-[1.2]"
    case "h3":
      return "text-2xl font-bold leading-[1.2]"
    case "h4":
      return "text-xl font-semibold leading-[1.3]"
    case "h5":
      return "text-lg font-semibold leading-[1.4]"
    case "h6":
      return "text-base font-semibold leading-[1.4]"
    case "code":
      return "font-mono text-sm bg-gray-100 px-4 py-2 rounded-lg whitespace-pre-wrap break-words"
    case "blockquote":
      return "text-base opacity-70 italic border-l-4 border-[var(--color-accent)] pl-6 py-1"
...
function getInlineFormattingClasses(
  ...
  if (code)
    classes.push("font-mono bg-gray-100 px-1 py-0.5 rounded")
...
function serializeTextNode(node: TextNode, indent: string = ""): string {
  ...
  if (type === "img") {
    ...
    if (caption) {
      html += `${indent}  <figcaption class="text-sm text-gray-500 text-center mt-3 italic">${escapeHtml(caption)}</figcaption>\n`
    }
