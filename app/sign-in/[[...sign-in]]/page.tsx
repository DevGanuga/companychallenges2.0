        ...
        <div className="w-full max-w-md text-center">
          ...
          <p className="mt-2 text-sm text-[var(--color-fg-subtle)]">
            {DEMO_MODE
              ...
              : <>Add your Clerk keys to <code className="rounded bg-[var(--color-bg-muted)] px-1">.env.local</code> to enable sign-in.</>
            }
          </p>
          <a
            href="/admin"
    ...
    <div className="flex min-h-screen items-center justify-center bg-[var(--color-bg-subtle)]">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-2xl font-semibold text-[var(--color-fg)]">Company Challenges</h1>
          <p className="mt-1 text-[var(--color-fg-muted)]">Sign in to access the admin panel</p>
        </div>
        <ClerkSignIn 
          appearance={{
            elements: {
